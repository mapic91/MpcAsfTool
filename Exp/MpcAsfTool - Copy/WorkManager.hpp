...
public:
    ...
    WorkManager(long Width, long Height, long Direction, long Bottom, long Left, unsigned long Interval, bool ShdIncluded,
                ...
                unsigned char AlphaMask, unsigned char ShadowAlpha)
    {
        Init(Width, Height, Direction, Bottom, Left, Interval, ShdIncluded,
             MakeShadow, ShdType, Sunx, Suny, Shdx, Shdy, Basecol, AlphaMask, ShadowAlpha);
    }
    ...
    void Init()
    {
        ...
        totalframecounts = 0;framecounts = 0;alphamask = 0; shadowalpha = 0xB9;
    }
    void Init(long Width, long Height, long Direction, long Bottom, long Left, unsigned long Interval, bool ShdIncluded,
                ...
                wxColor Basecol, unsigned char AlphaMask, unsigned char ShadowAlpha)
    {
        Init();
        ...
        basecolor = Basecol; alphamask = AlphaMask; shadowalpha = ShadowAlpha;
    }
    ...
    wxImage GetUndeletedGlobalizedImage(unsigned long index);
