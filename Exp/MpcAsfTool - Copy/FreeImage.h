...
typedef uint32_t FILOCDWORD;
typedef int32_t FILOCLONG;
...
typedef FILOCLONG BOOL;
typedef unsigned char BYTE;
typedef unsigned short WORD;
typedef unsigned FILOCLONG FILOCDWORD;
typedef FILOCLONG FILOCLONG;
...
typedef struct tagFILOCFILOCBITMAPINFOHEADER{
  FILOCDWORD biSize;
  FILOCLONG  biWidth;
  FILOCLONG  biHeight;
  WORD  biPlanes;
  WORD  biBitCount;
  FILOCDWORD biCompression;
  FILOCDWORD biSizeImage;
  FILOCLONG  biXPelsPerMeter;
  FILOCLONG  biYPelsPerMeter;
  FILOCDWORD biClrUsed;
  FILOCDWORD biClrImportant;
} FILOCFILOCBITMAPINFOHEADER, *PFILOCFILOCBITMAPINFOHEADER;




typedef struct tagFILOCBITMAPINFO {
  FILOCFILOCBITMAPINFOHEADER bmiHeader;
...
FI_STRUCT (FIICCPROFILE) {
	...
	FILOCDWORD	size;	// profile's size measured in bytes
...
FI_ENUM(FREE_IMAGE_TYPE) {
	...
	FIT_UINT32	= 4,	// array of unsigned FILOCLONG	: unsigned 32-bit
	FIT_INT32	= 5,	// array of FILOCLONG			: signed 32-bit
...
FI_ENUM(FREE_IMAGE_MDTYPE) {
	...
	FIDT_FILOCLONG		= 4,	// 32-bit unsigned integer
	FIDT_RATIONAL	= 5,	// 64-bit unsigned fraction
	FIDT_SBYTE		= 6,	// 8-bit signed integer
	FIDT_UNDEFINED	= 7,	// 8-bit untyped data
	FIDT_SSHORT		= 8,	// 16-bit signed integer
	FIDT_SFILOCLONG		= 9,	// 32-bit signed integer
	FIDT_SRATIONAL	= 10,	// 64-bit signed fraction
	FIDT_FLOAT		= 11,	// 32-bit IEEE floating point
	FIDT_DOUBLE		= 12,	// 64-bit IEEE floating point
	FIDT_IFD		= 13,	// 32-bit unsigned integer (offset)
	FIDT_PALETTE	= 14,	// 32-bit FILOCRGBQUAD
	FIDT_FILOCLONG8		= 16,	// 64-bit unsigned integer
	FIDT_SFILOCLONG8		= 17,	// 64-bit signed integer
...
typedef int (DLL_CALLCONV *FI_SeekProc) (fi_handle handle, FILOCLONG offset, int origin);
typedef FILOCLONG (DLL_CALLCONV *FI_TellProc) (fi_handle handle);
...
DLL_API FIMEMORY *DLL_CALLCONV FreeImage_OpenMemory(BYTE *data FI_DEFAULT(0), FILOCDWORD size_in_bytes FI_DEFAULT(0));
DLL_API void DLL_CALLCONV FreeImage_CloseMemory(FIMEMORY *stream);
DLL_API FIBITMAP *DLL_CALLCONV FreeImage_LoadFromMemory(FREE_IMAGE_FORMAT fif, FIMEMORY *stream, int flags FI_DEFAULT(0));
DLL_API BOOL DLL_CALLCONV FreeImage_SaveToMemory(FREE_IMAGE_FORMAT fif, FIBITMAP *dib, FIMEMORY *stream, int flags FI_DEFAULT(0));
DLL_API FILOCLONG DLL_CALLCONV FreeImage_TellMemory(FIMEMORY *stream);
DLL_API BOOL DLL_CALLCONV FreeImage_SeekMemory(FIMEMORY *stream, FILOCLONG offset, int origin);
DLL_API BOOL DLL_CALLCONV FreeImage_AcquireMemory(FIMEMORY *stream, BYTE **data, FILOCDWORD *size_in_bytes);
...
DLL_API BOOL DLL_CALLCONV FreeImage_GetPixelColor(FIBITMAP *dib, unsigned x, unsigned y, FILOCRGBQUAD *value);
DLL_API BOOL DLL_CALLCONV FreeImage_SetPixelIndex(FIBITMAP *dib, unsigned x, unsigned y, BYTE *value);
DLL_API BOOL DLL_CALLCONV FreeImage_SetPixelColor(FIBITMAP *dib, unsigned x, unsigned y, FILOCRGBQUAD *value);
...
DLL_API FILOCFILOCBITMAPINFOHEADER *DLL_CALLCONV FreeImage_GetInfoHeader(FIBITMAP *dib);
...
DLL_API BOOL DLL_CALLCONV FreeImage_GetBackgroundColor(FIBITMAP *dib, FILOCRGBQUAD *bkcolor);
DLL_API BOOL DLL_CALLCONV FreeImage_SetBackgroundColor(FIBITMAP *dib, FILOCRGBQUAD *bkcolor);
...
DLL_API FIICCPROFILE *DLL_CALLCONV FreeImage_CreateICCProfile(FIBITMAP *dib, void *data, FILOCLONG size);
DLL_API void DLL_CALLCONV FreeImage_DestroyICCProfile(FIBITMAP *dib);

// Line conversion routines -------------------------------------------------

DLL_API void DLL_CALLCONV FreeImage_ConvertLine1To4(BYTE *target, BYTE *source, int width_in_pixels);
DLL_API void DLL_CALLCONV FreeImage_ConvertLine8To4(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
...
DLL_API void DLL_CALLCONV FreeImage_ConvertLine1To16_555(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
DLL_API void DLL_CALLCONV FreeImage_ConvertLine4To16_555(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
DLL_API void DLL_CALLCONV FreeImage_ConvertLine8To16_555(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
...
DLL_API void DLL_CALLCONV FreeImage_ConvertLine1To16_565(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
DLL_API void DLL_CALLCONV FreeImage_ConvertLine4To16_565(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
DLL_API void DLL_CALLCONV FreeImage_ConvertLine8To16_565(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
...
DLL_API void DLL_CALLCONV FreeImage_ConvertLine1To24(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
DLL_API void DLL_CALLCONV FreeImage_ConvertLine4To24(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
DLL_API void DLL_CALLCONV FreeImage_ConvertLine8To24(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
...
DLL_API void DLL_CALLCONV FreeImage_ConvertLine1To32(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
DLL_API void DLL_CALLCONV FreeImage_ConvertLine4To32(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
DLL_API void DLL_CALLCONV FreeImage_ConvertLine8To32(BYTE *target, BYTE *source, int width_in_pixels, FILOCRGBQUAD *palette);
...
DLL_API FILOCDWORD DLL_CALLCONV FreeImage_ZLibCompress(BYTE *target, FILOCDWORD target_size, BYTE *source, FILOCDWORD source_size);
DLL_API FILOCDWORD DLL_CALLCONV FreeImage_ZLibUncompress(BYTE *target, FILOCDWORD target_size, BYTE *source, FILOCDWORD source_size);
DLL_API FILOCDWORD DLL_CALLCONV FreeImage_ZLibGZip(BYTE *target, FILOCDWORD target_size, BYTE *source, FILOCDWORD source_size);
DLL_API FILOCDWORD DLL_CALLCONV FreeImage_ZLibGUnzip(BYTE *target, FILOCDWORD target_size, BYTE *source, FILOCDWORD source_size);
DLL_API FILOCDWORD DLL_CALLCONV FreeImage_ZLibCRC32(FILOCDWORD crc, BYTE *source, FILOCDWORD source_size);
...
DLL_API FILOCDWORD DLL_CALLCONV FreeImage_GetTagCount(FITAG *tag);
DLL_API FILOCDWORD DLL_CALLCONV FreeImage_GetTagLength(FITAG *tag);
...
DLL_API BOOL DLL_CALLCONV FreeImage_SetTagCount(FITAG *tag, FILOCDWORD count);
DLL_API BOOL DLL_CALLCONV FreeImage_SetTagLength(FITAG *tag, FILOCDWORD length);
...
DLL_API BOOL DLL_CALLCONV FreeImage_GetHistogram(FIBITMAP *dib, FILOCDWORD *histo, FREE_IMAGE_COLOR_CHANNEL channel FI_DEFAULT(FICC_BLACK));
...
DLL_API unsigned DLL_CALLCONV FreeImage_ApplyColorMapping(FIBITMAP *dib, FILOCRGBQUAD *srccolors, FILOCRGBQUAD *dstcolors, unsigned count, BOOL ignore_alpha, BOOL swap);
DLL_API unsigned DLL_CALLCONV FreeImage_SwapColors(FIBITMAP *dib, FILOCRGBQUAD *color_a, FILOCRGBQUAD *color_b, BOOL ignore_alpha);
...
DLL_API FIBITMAP *DLL_CALLCONV FreeImage_Composite(FIBITMAP *fg, BOOL useFileBkg FI_DEFAULT(FALSE), FILOCRGBQUAD *appBkColor FI_DEFAULT(NULL), FIBITMAP *bg FI_DEFAULT(NULL));
