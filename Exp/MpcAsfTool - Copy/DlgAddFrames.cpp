...
DlgAddFrames::DlgAddFrames(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
    ...
    Create(parent, wxID_ANY, _("添加帧"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
    ...
    Button_UP = new wxButton(this, ID_BUTTON3, _("∧"), wxPoint(472,130), wxSize(18,23), 0, wxDefaultValidator, _T("ID_BUTTON3"));
    Button_Down = new wxButton(this, ID_BUTTON4, _("∨"), wxPoint(472,160), wxSize(18,23), 0, wxDefaultValidator, _T("ID_BUTTON4"));
    Button_Del = new wxButton(this, ID_BUTTON5, _("×"), wxPoint(472,190), wxSize(18,23), 0, wxDefaultValidator, _T("ID_BUTTON5"));
    Button_OK = new wxButton(this, ID_BUTTON1, _("确定"), wxPoint(88,408), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
    Button1 = new wxButton(this, ID_BUTTON2, _("取消"), wxPoint(312,408), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
...
{
    ListCtrl_Files->InsertColumn(0, _("文件"));
